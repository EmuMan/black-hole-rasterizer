...
public:
	...
	virtual void mousePosCallback(GLFWwindow* window, double newX, double newY) = 0;
...
private:
	...
	static void mousePos_callback(GLFWwindow* window, double in_newX, double in_newY);
